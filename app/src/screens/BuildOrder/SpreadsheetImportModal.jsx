    ...
    <Modal onClose={onClose} size="lg">
      <div className="modal__head">
        <div className="row between">
          <div>
            ...
            <h2>{step === 'upload' ? 'Upload a hospital order spreadsheet' : `Preview — ${fileName}`}</h2>
          </div>
          ...
          <div className="col gap-16">
            ...
            <div style={{ background: 'var(--surface-2)', border: '1px solid var(--border)', borderRadius: 8, padding: '12px 14px' }}>
              ...
              <table className="tbl" style={{ fontSize: 12.5 }}>
                ...
                <tbody>
                  <tr><td className="mono">SC-04128</td><td>Amoxicillin 250mg/5ml</td><td className="mono">10</td></tr>
            ...
            {unmatched.length > 0 && (
              <div>
                ...
                <div className="muted" style={{ fontSize: 12, marginTop: 6 }}>
                  These SKUs were not found in the product catalogue. Check for typos.
                </div>
              </div>
            )}
      ...
      <div className="modal__foot">
        <div className="muted" style={{ fontSize: 12.5 }}>
          {step === 'upload' && 'Upload a hospital spreadsheet to pre-fill the order basket'}
